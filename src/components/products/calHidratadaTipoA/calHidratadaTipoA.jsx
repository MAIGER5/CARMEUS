...
import styles from './calHidratadaTipoA.module.css';
...
import dataCalHidratadaTypeA from '../../utils/data/dataCalHidratadaTypeA';



export const CalHidratadaTipoA = () => {

  const data = dataCalHidratadaTypeA;
